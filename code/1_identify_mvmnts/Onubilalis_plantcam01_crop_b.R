...
setwd("/cluster/[anonymized]/pi/ajLAM_Onubilalis_be_mf_202208")
...
x_left <- 600 #cage-specific, depending on camera arrangement
x_right <- 2400 #cage-specific, depending on camera arrangement
...
out_file_name = "Onubilalis_be_mf_v3" #project-specific
