...
setwd("/cluster/[anonymized]/pi/ajLAM_Onubilalis_uz_mf_202208")
...
pi_sub_folder <- "plantcam01"
sex <- "female" #cage/project-specific
x_left <- 585 #cage-specific, depending on camera arrangement
x_right <- 2385 #cage-specific, depending on camera arrangement
...
#for ECB, I like 99.9% and 10, 
out_file_name = "Onubilalis_uz_mf_v3" #project-specific
...
start_photophase = 3 #project-specific
end_photophase = 19 #project-specific
genus = "ostrinia"
species = "nubilalis"
animal = "white"
###
